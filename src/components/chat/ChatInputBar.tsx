...
export function ChatInputBar({ onSend, disabled }: ChatInputBarProps) {
  ...
  return (
    <div className="px-6 pb-4 pt-2.5 flex-shrink-0">
      <div
        className="flex items-center gap-2 bg-white dark:bg-[#1a2535] border border-[#e4e7ec] dark:border-[#2d3748] rounded-[14px] px-3.5 py-2 shadow-sm dark:shadow-none transition-colors focus-within:border-brand-500"
      >
        <textarea
          ref={taRef}
          rows={1}
