    ...
    <>
      ...
      <Modal isOpen={open} onClose={handleClose} className="max-w-md p-6">
        ...
        <p className="mb-5 text-sm text-gray-500 dark:text-gray-400">
          Upserts KPI Master records for the given year only — other years are unaffected.
          Ensure the Spreadsheet has invited the registered credential email before ingesting.
        </p>
